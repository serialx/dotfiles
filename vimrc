...
if has("gui_running")
	...
	elseif has("macunix")
		silent! set gfn=Monaco:h13 gfw=AppleGothic\ Regular:h14
	endif
...
if has("autocmd")
	...
	au FileType go setl lcs=tab:\ \ ,trail:· ts=4 sw=4
...
elseif has("macunix")
	if has("transparency")
		nnoremap <silent> <a-[> :set transp=0<CR>
		nnoremap <silent> <a-]> :set transp=10<CR>
	endif
endif
"let g:SuperTabDefaultCompletionT8ype = "context"
...
" CtrlP Ignore
set wildignore+=*/tmp/*,*.so,*.swp,*.zip,venv,env,*.pyc     " MacOSX/Linux
